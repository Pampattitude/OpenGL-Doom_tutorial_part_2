...
void clipBehindPlayer(int *x1, int *y1, int *z1, int x2, int y2,
                      int z2) // clip line
{
...
void drawWall(int x1, int x2, int b1, int b2, int t1, int t2, int s, int w,
              int frontBack) {
  int x, y;
  // wall texture
  int wt = W[w].wt;
